; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/type_hierarchies/type_hierarchy_8.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/type_hierarchies/type_hierarchy_8.cpp"
...
entry:
  ...
  %nc = alloca %class.NonvirtualClass, align 1
  %ns = alloca %struct.NonvirtualStruct, align 4
  store i32 0, i32* %retval, align 4
  call void @_ZN5ChildC2Ev(%struct.Child* noundef nonnull align 8 dereferenceable(8) %c) #3
  %call = call noundef i32 @_ZN15NonvirtualClass3tarEv(%class.NonvirtualClass* noundef nonnull align 1 dereferenceable(1) %nc)
  %j = getelementptr inbounds %struct.NonvirtualStruct, %struct.NonvirtualStruct* %ns, i32 0, i32 0
...
define linkonce_odr dso_local noundef i32 @_ZN15NonvirtualClass3tarEv(%class.NonvirtualClass* noundef nonnull align 1 dereferenceable(1) %this) #2 comdat align 2 {
entry:
  %this.addr = alloca %class.NonvirtualClass*, align 8
  store %class.NonvirtualClass* %this, %class.NonvirtualClass** %this.addr, align 8
  %this1 = load %class.NonvirtualClass*, %class.NonvirtualClass** %this.addr, align 8
  ret i32 42
}
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define linkonce_odr dso_local noundef i32 @_ZN5Child3bazEv(%struct.Child* noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #2 comdat align 2 {
entry:
  %this.addr = alloca %struct.Child*, align 8
  store %struct.Child* %this, %struct.Child** %this.addr, align 8
  %this1 = load %struct.Child*, %struct.Child** %this.addr, align 8
