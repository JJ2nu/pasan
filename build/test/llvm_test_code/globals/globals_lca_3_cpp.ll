; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/globals/globals_lca_3.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/globals/globals_lca_3.cpp"
...
@llvm.global_ctors = appending global [2 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_Z12myGlobalCtorv, i8* null }, { i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_globals_lca_3.cpp, i8* null }]
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local void @_Z12myGlobalCtorv() #0 {
entry:
  store i32 45, i32* @bar, align 4
  ret void
}
...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i32 noundef %2, i32 noundef %3)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_globals_lca_3.cpp() #1 section ".text.startup" {
entry:
