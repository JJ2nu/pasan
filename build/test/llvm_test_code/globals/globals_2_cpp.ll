; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/globals/globals_2.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/globals/globals_2.cpp"
...
$_ZN5Child3fooERi = comdat any

$_ZN4BaseC2Ev = comdat any

$_ZN4Base3fooERi = comdat any
...
@globalInt = dso_local global i32 10, align 4
@_ZTV5Child = linkonce_odr dso_local unnamed_addr constant { [3 x i8*] } { [3 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI5Child to i8*), i8* bitcast (void (%struct.Child*, i32*)* @_ZN5Child3fooERi to i8*)] }, comdat, align 8
...
@_ZTV4Base = linkonce_odr dso_local unnamed_addr constant { [3 x i8*] } { [3 x i8*] [i8* null, i8* bitcast ({ i8*, i8* }* @_ZTI4Base to i8*), i8* bitcast (void (%struct.Base*, i32*)* @_ZN4Base3fooERi to i8*)] }, comdat, align 8
...
entry:
  ...
  call void @_ZN5Child3fooERi(%struct.Child* noundef nonnull align 8 dereferenceable(8) %c, i32* noundef nonnull align 4 dereferenceable(4) %i)
  call void @_ZN4BaseC2Ev(%struct.Base* noundef nonnull align 8 dereferenceable(8) %b) #3
  call void @_ZN4Base3fooERi(%struct.Base* noundef nonnull align 8 dereferenceable(8) %b, i32* noundef nonnull align 4 dereferenceable(4) %i)
  ret i32 0
}
...
define linkonce_odr dso_local void @_ZN5Child3fooERi(%struct.Child* noundef nonnull align 8 dereferenceable(8) %this, i32* noundef nonnull align 4 dereferenceable(4) %a) unnamed_addr #2 comdat align 2 {
entry:
  %this.addr = alloca %struct.Child*, align 8
  ...
  %this1 = load %struct.Child*, %struct.Child** %this.addr, align 8
  %0 = load i32, i32* @globalInt, align 4
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN4Base3fooERi(%struct.Base* noundef nonnull align 8 dereferenceable(8) %this, i32* noundef nonnull align 4 dereferenceable(4) %a) unnamed_addr #2 comdat align 2 {
entry:
  %this.addr = alloca %struct.Base*, align 8
  %a.addr = alloca i32*, align 8
  store %struct.Base* %this, %struct.Base** %this.addr, align 8
