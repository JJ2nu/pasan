; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/call_graphs/virtual_call_5.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/call_graphs/virtual_call_5.cpp"
...
entry:
  ...
  call void @_ZN1BC2Ev(%struct.B* noundef nonnull align 8 dereferenceable(8) %0) #6
  %1 = bitcast %struct.B* %0 to %struct.A*
  store %struct.A* %1, %struct.A** %a, align 8
  %2 = load %struct.A*, %struct.A** %a, align 8
  call void @_ZN1A4funcEv(%struct.A* noundef nonnull align 8 dereferenceable(8) %2)
  ...
  %isnull = icmp eq %struct.A* %6, null
  br i1 %isnull, label %delete.end, label %delete.notnull

delete.notnull:                                   ; preds = %entry
  %7 = bitcast %struct.A* %6 to void (%struct.A*)***
  %vtable1 = load void (%struct.A*)**, void (%struct.A*)*** %7, align 8
  %vfn2 = getelementptr inbounds void (%struct.A*)*, void (%struct.A*)** %vtable1, i64 1
  %8 = load void (%struct.A*)*, void (%struct.A*)** %vfn2, align 8
  call void %8(%struct.A* noundef nonnull align 8 dereferenceable(8) %6) #6
  br label %delete.end
...
define linkonce_odr dso_local void @_ZN1A4funcEv(%struct.A* noundef nonnull align 8 dereferenceable(8) %this) #3 comdat align 2 {
entry:
