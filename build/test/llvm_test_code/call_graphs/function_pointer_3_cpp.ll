; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/call_graphs/function_pointer_3.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/call_graphs/function_pointer_3.cpp"
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local noundef i32 @_Z3bari(i32 noundef %i) #0 {
entry:
...
entry:
  ...
  store i32 ()* @_Z3foov, i32 ()** %fptr, align 8
  store i32 ()* bitcast (i32 (i32)* @_Z3bari to i32 ()*), i32 ()** %fptr, align 8
