; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/call_graphs/virtual_call_6.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/call_graphs/virtual_call_6.cpp"
...
entry:
  ...
  call void @_ZN1AC2Ev(%struct.A* noundef nonnull align 8 dereferenceable(8) %a) #4
  invoke void @_ZN1A5VfuncEv(%struct.A* noundef nonnull align 8 dereferenceable(8) %a)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  call void @_ZN1BC2Ev(%struct.B* noundef nonnull align 8 dereferenceable(8) %b) #4
  invoke void @_ZN1B5VfuncEv(%struct.B* noundef nonnull align 8 dereferenceable(8) %b)
          to label %invoke.cont2 unwind label %lpad1

invoke.cont2:                                     ; preds = %invoke.cont
  call void @_ZN1BD2Ev(%struct.B* noundef nonnull align 8 dereferenceable(8) %b) #4
  call void @_ZN1AD2Ev(%struct.A* noundef nonnull align 8 dereferenceable(8) %a) #4
  ret i32 0
...
define linkonce_odr dso_local void @_ZN1A5VfuncEv(%struct.A* noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #2 comdat align 2 {
entry:
  %this.addr = alloca %struct.A*, align 8
  store %struct.A* %this, %struct.A** %this.addr, align 8
  %this1 = load %struct.A*, %struct.A** %this.addr, align 8
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN1B5VfuncEv(%struct.B* noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #2 comdat align 2 {
entry:
  %this.addr = alloca %struct.B*, align 8
  store %struct.B* %this, %struct.B** %this.addr, align 8
  %this1 = load %struct.B*, %struct.B** %this.addr, align 8
