; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/constness/pointer/pointer_02.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/constness/pointer/pointer_02.cpp"
...
entry:
  ...
  store i32 12, i32* %i, align 4, !dbg !15
  call void @llvm.dbg.declare(metadata i32** %p, metadata !16, metadata !DIExpression()), !dbg !18
  store i32* %i, i32** %p, align 8, !dbg !18
  call void @llvm.dbg.declare(metadata i32*** %pp, metadata !19, metadata !DIExpression()), !dbg !21
  store i32** %p, i32*** %pp, align 8, !dbg !21
  %0 = load i32**, i32*** %pp, align 8, !dbg !22
  %1 = load i32*, i32** %0, align 8, !dbg !23
  store i32 10, i32* %1, align 4, !dbg !24
  ret i32 0, !dbg !25
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/constness/pointer/pointer_02.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/constness/pointer", checksumkind: CSK_MD5, checksum: "8399ded1bd525158026d4b39182dbd7b")
...
!9 = !DIFile(filename: "test/llvm_test_code/constness/pointer/pointer_02.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "8399ded1bd525158026d4b39182dbd7b")
...
!16 = !DILocalVariable(name: "p", scope: !8, file: !9, line: 4, type: !17)
!17 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!18 = !DILocation(line: 4, column: 8, scope: !8)
!19 = !DILocalVariable(name: "pp", scope: !8, file: !9, line: 5, type: !20)
...
!23 = !DILocation(line: 6, column: 4, scope: !8)
!24 = !DILocation(line: 6, column: 8, scope: !8)
