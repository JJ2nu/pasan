; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/constness/pointer/pointer_03.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/constness/pointer/pointer_03.cpp"
...
entry:
  ...
  store i32 12, i32* %j, align 4, !dbg !17
  call void @llvm.dbg.declare(metadata i32** %pj, metadata !18, metadata !DIExpression()), !dbg !20
  store i32* %j, i32** %pj, align 8, !dbg !20
  %0 = load i32*, i32** %pj, align 8, !dbg !21
  store i32 42, i32* %0, align 4, !dbg !22
  store i32* %i, i32** %pj, align 8, !dbg !23
  ret i32 0, !dbg !24
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/constness/pointer/pointer_03.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/constness/pointer", checksumkind: CSK_MD5, checksum: "9b52db5a22cdd55650e061942c9865ac")
...
!9 = !DIFile(filename: "test/llvm_test_code/constness/pointer/pointer_03.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "9b52db5a22cdd55650e061942c9865ac")
...
!18 = !DILocalVariable(name: "pj", scope: !8, file: !9, line: 5, type: !19)
!19 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!20 = !DILocation(line: 5, column: 8, scope: !8)
!21 = !DILocation(line: 6, column: 4, scope: !8)
