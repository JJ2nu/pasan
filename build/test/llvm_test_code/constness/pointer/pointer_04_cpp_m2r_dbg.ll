; ModuleID = 'pointer_04_cpp_m2r_dbg.ll'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/constness/pointer/pointer_04.cpp"
...
entry:
  ...
  %call1 = call noalias noundef nonnull i8* @_Znwm(i64 noundef 4) #3, !dbg !18, !heapallocsite !12
  %1 = bitcast i8* %call1 to i32*, !dbg !18
  store i32 99, i32* %1, align 4, !dbg !18
  call void @llvm.dbg.value(metadata i32* %1, metadata !15, metadata !DIExpression()), !dbg !17
  store i32 20, i32* %1, align 4, !dbg !19
  ret i32 0, !dbg !20
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/constness/pointer/pointer_04.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/constness/pointer", checksumkind: CSK_MD5, checksum: "09bcfa0409cd357adeaa2779d4ce4054")
...
!9 = !DIFile(filename: "test/llvm_test_code/constness/pointer/pointer_04.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "09bcfa0409cd357adeaa2779d4ce4054")
!10 = !DISubroutineType(types: !11)
!11 = !{!12}
!12 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!13 = !{}
!14 = !DILocation(line: 4, column: 12, scope: !8)
!15 = !DILocalVariable(name: "p", scope: !8, file: !9, line: 4, type: !16)
!16 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!17 = !DILocation(line: 0, scope: !8)
!18 = !DILocation(line: 5, column: 7, scope: !8)
