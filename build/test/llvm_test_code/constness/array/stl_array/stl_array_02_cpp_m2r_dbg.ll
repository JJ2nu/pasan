; ModuleID = 'stl_array_02_cpp_m2r_dbg.ll'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/constness/array/stl_array/stl_array_02.cpp"
...
entry:
  ...
  %call = call noundef nonnull align 4 dereferenceable(4) i32* @_ZNSt5arrayIiLm3EEixEm(%"struct.std::array"* noundef nonnull align 4 dereferenceable(12) %a, i64 noundef 0) #4, !dbg !126
...
define linkonce_odr dso_local noundef nonnull align 4 dereferenceable(4) i32* @_ZNSt5arrayIiLm3EEixEm(%"struct.std::array"* noundef nonnull align 4 dereferenceable(12) %this, i64 noundef %__n) #3 comdat align 2 !dbg !129 {
entry:
  ...
  %_M_elems = getelementptr inbounds %"struct.std::array", %"struct.std::array"* %this, i32 0, i32 0, !dbg !134
  %call = call noundef nonnull align 4 dereferenceable(4) i32* @_ZNSt14__array_traitsIiLm3EE6_S_refERA3_Kim([3 x i32]* noundef nonnull align 4 dereferenceable(12) %_M_elems, i64 noundef %__n) #4, !dbg !135
  ret i32* %call, !dbg !136
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local noundef nonnull align 4 dereferenceable(4) i32* @_ZNSt14__array_traitsIiLm3EE6_S_refERA3_Kim([3 x i32]* noundef nonnull align 4 dereferenceable(12) %__t, i64 noundef %__n) #3 comdat align 2 !dbg !137 {
entry:
  call void @llvm.dbg.value(metadata [3 x i32]* %__t, metadata !138, metadata !DIExpression()), !dbg !139
  call void @llvm.dbg.value(metadata i64 %__n, metadata !140, metadata !DIExpression()), !dbg !139
  %arrayidx = getelementptr inbounds [3 x i32], [3 x i32]* %__t, i64 0, i64 %__n, !dbg !141
  ret i32* %arrayidx, !dbg !142
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/constness/array/stl_array/stl_array_02.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/constness/array/stl_array", checksumkind: CSK_MD5, checksum: "3911482111bac013721f9ceec5451998")
!2 = !{!3}
...
!15 = !DIFile(filename: "test/llvm_test_code/constness/array/stl_array/stl_array_02.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "3911482111bac013721f9ceec5451998")
...
!129 = distinct !DISubprogram(name: "operator[]", linkageName: "_ZNSt5arrayIiLm3EEixEm", scope: !21, file: !22, line: 186, type: !99, scopeLine: 187, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !98, retainedNodes: !19)
...
!133 = !DILocalVariable(name: "__n", arg: 2, scope: !129, file: !22, line: 186, type: !92)
!134 = !DILocation(line: 189, column: 26, scope: !129)
!135 = !DILocation(line: 189, column: 9, scope: !129)
!136 = !DILocation(line: 189, column: 2, scope: !129)
!137 = distinct !DISubprogram(name: "_S_ref", linkageName: "_ZNSt14__array_traitsIiLm3EE6_S_refERA3_Kim", scope: !26, file: !22, line: 56, type: !29, scopeLine: 57, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !28, retainedNodes: !19)
!138 = !DILocalVariable(name: "__t", arg: 1, scope: !137, file: !22, line: 56, type: !32)
!139 = !DILocation(line: 0, scope: !137)
!140 = !DILocalVariable(name: "__n", arg: 2, scope: !137, file: !22, line: 56, type: !34)
!141 = !DILocation(line: 57, column: 33, scope: !137)
!142 = !DILocation(line: 57, column: 9, scope: !137)
