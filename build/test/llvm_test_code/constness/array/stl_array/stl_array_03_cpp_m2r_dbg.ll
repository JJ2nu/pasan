; ModuleID = 'stl_array_03_cpp_m2r_dbg.ll'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/constness/array/stl_array/stl_array_03.cpp"
...
@__const.main.a = private unnamed_addr constant %"struct.std::array" { [3 x i32] [i32 10, i32 20, i32 30] }, align 4
...
entry:
  ...
  %call = call noundef nonnull align 4 dereferenceable(4) i32* @_ZNSt5arrayIiLm3EE2atEm(%"struct.std::array"* noundef nonnull align 4 dereferenceable(12) %a, i64 noundef 0), !dbg !126
  store i32 42, i32* %call, align 4, !dbg !127
  ret i32 0, !dbg !128
}
...
define linkonce_odr dso_local noundef nonnull align 4 dereferenceable(4) i32* @_ZNSt5arrayIiLm3EE2atEm(%"struct.std::array"* noundef nonnull align 4 dereferenceable(12) %this, i64 noundef %__n) #3 comdat align 2 !dbg !129 {
entry:
  call void @llvm.dbg.value(metadata %"struct.std::array"* %this, metadata !130, metadata !DIExpression()), !dbg !132
  call void @llvm.dbg.value(metadata i64 %__n, metadata !133, metadata !DIExpression()), !dbg !132
  %cmp = icmp uge i64 %__n, 3, !dbg !134
  br i1 %cmp, label %if.then, label %if.end, !dbg !136

if.then:                                          ; preds = %entry
  call void (i8*, ...) @_ZSt24__throw_out_of_range_fmtPKcz(i8* noundef getelementptr inbounds ([52 x i8], [52 x i8]* @.str, i64 0, i64 0), i64 noundef %__n, i64 noundef 3) #6, !dbg !137
  unreachable, !dbg !137

if.end:                                           ; preds = %entry
  %_M_elems = getelementptr inbounds %"struct.std::array", %"struct.std::array"* %this, i32 0, i32 0, !dbg !138
  %call = call noundef nonnull align 4 dereferenceable(4) i32* @_ZNSt14__array_traitsIiLm3EE6_S_refERA3_Kim([3 x i32]* noundef nonnull align 4 dereferenceable(12) %_M_elems, i64 noundef %__n) #7, !dbg !139
  ret i32* %call, !dbg !140
}
...
define linkonce_odr dso_local noundef nonnull align 4 dereferenceable(4) i32* @_ZNSt14__array_traitsIiLm3EE6_S_refERA3_Kim([3 x i32]* noundef nonnull align 4 dereferenceable(12) %__t, i64 noundef %__n) #5 comdat align 2 !dbg !141 {
entry:
  call void @llvm.dbg.value(metadata [3 x i32]* %__t, metadata !142, metadata !DIExpression()), !dbg !143
  call void @llvm.dbg.value(metadata i64 %__n, metadata !144, metadata !DIExpression()), !dbg !143
  %arrayidx = getelementptr inbounds [3 x i32], [3 x i32]* %__t, i64 0, i64 %__n, !dbg !145
  ret i32* %arrayidx, !dbg !146
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/constness/array/stl_array/stl_array_03.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/constness/array/stl_array", checksumkind: CSK_MD5, checksum: "c30383da3b1699202986557b74ac1df0")
!2 = !{!3}
...
!15 = !DIFile(filename: "test/llvm_test_code/constness/array/stl_array/stl_array_03.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "c30383da3b1699202986557b74ac1df0")
...
!126 = !DILocation(line: 5, column: 5, scope: !14)
!127 = !DILocation(line: 5, column: 11, scope: !14)
!128 = !DILocation(line: 6, column: 3, scope: !14)
!129 = distinct !DISubprogram(name: "at", linkageName: "_ZNSt5arrayIiLm3EE2atEm", scope: !21, file: !22, line: 202, type: !99, scopeLine: 203, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !107, retainedNodes: !19)
!130 = !DILocalVariable(name: "this", arg: 1, scope: !129, type: !131, flags: DIFlagArtificial | DIFlagObjectPointer)
!131 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !21, size: 64)
!132 = !DILocation(line: 0, scope: !129)
!133 = !DILocalVariable(name: "__n", arg: 2, scope: !129, file: !22, line: 202, type: !92)
!134 = !DILocation(line: 204, column: 10, scope: !135)
!135 = distinct !DILexicalBlock(scope: !129, file: !22, line: 204, column: 6)
!136 = !DILocation(line: 204, column: 6, scope: !129)
!137 = !DILocation(line: 205, column: 4, scope: !135)
!138 = !DILocation(line: 208, column: 26, scope: !129)
!139 = !DILocation(line: 208, column: 9, scope: !129)
!140 = !DILocation(line: 208, column: 2, scope: !129)
!141 = distinct !DISubprogram(name: "_S_ref", linkageName: "_ZNSt14__array_traitsIiLm3EE6_S_refERA3_Kim", scope: !26, file: !22, line: 56, type: !29, scopeLine: 57, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !28, retainedNodes: !19)
!142 = !DILocalVariable(name: "__t", arg: 1, scope: !141, file: !22, line: 56, type: !32)
!143 = !DILocation(line: 0, scope: !141)
!144 = !DILocalVariable(name: "__n", arg: 2, scope: !141, file: !22, line: 56, type: !34)
!145 = !DILocation(line: 57, column: 33, scope: !141)
!146 = !DILocation(line: 57, column: 9, scope: !141)
