; ModuleID = 'array_08_cpp_m2r_dbg.ll'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/constness/array/array_08.cpp"
...
entry:
  %call = call noalias noundef nonnull i8* @_Znam(i64 noundef 20) #3, !dbg !14, !heapallocsite !12
  ...
  store i32 20, i32* %arrayidx, align 4, !dbg !19
  %arrayidx1 = getelementptr inbounds i32, i32* %0, i64 2, !dbg !20
  store i32 20, i32* %arrayidx1, align 4, !dbg !21
  ret i32 0, !dbg !22
}
...
declare dso_local noundef nonnull i8* @_Znam(i64 noundef) #2
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/constness/array/array_08.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/constness/array", checksumkind: CSK_MD5, checksum: "9e908a261d0cc0725d63abd0c346c65d")
...
!9 = !DIFile(filename: "test/llvm_test_code/constness/array/array_08.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "9e908a261d0cc0725d63abd0c346c65d")
...
!19 = !DILocation(line: 4, column: 8, scope: !8)
!20 = !DILocation(line: 5, column: 3, scope: !8)
!21 = !DILocation(line: 5, column: 8, scope: !8)
