; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/xtaint/xtaint11.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/xtaint/xtaint11.cpp"
...
@.str.1 = private unnamed_addr constant [66 x i8] c"/home/jinu/Desktop/phasar/test/llvm_test_code/xtaint/xtaint11.cpp\00", section "llvm.metadata"
...
entry:
  ...
  %.addr1 = bitcast i32** %.addr to i8*
  call void @llvm.var.annotation(i8* %.addr1, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([66 x i8], [66 x i8]* @.str.1, i32 0, i32 0), i32 7, i8* null)
  ret void
}
...
entry:
  ...
  %call1 = call noundef %struct.IntPair* @_ZNKSt10unique_ptrI7IntPairSt14default_deleteIS0_EEptEv(%"class.std::unique_ptr"* noundef nonnull align 8 dereferenceable(8) %mem) #10
  %x = getelementptr inbounds %struct.IntPair, %struct.IntPair* %call1, i32 0, i32 0
  store i32 %call, i32* %x, align 4
  %call2 = call noundef %struct.IntPair* @_ZNKSt10unique_ptrI7IntPairSt14default_deleteIS0_EEptEv(%"class.std::unique_ptr"* noundef nonnull align 8 dereferenceable(8) %mem) #10
  %x3 = getelementptr inbounds %struct.IntPair, %struct.IntPair* %call2, i32 0, i32 0
  call void @_Z8sanitizeRi(i32* noundef nonnull align 4 dereferenceable(4) %x3) #10
  %call4 = call noundef %struct.IntPair* @_ZNKSt10unique_ptrI7IntPairSt14default_deleteIS0_EEptEv(%"class.std::unique_ptr"* noundef nonnull align 8 dereferenceable(8) %mem) #10
  %x5 = getelementptr inbounds %struct.IntPair, %struct.IntPair* %call4, i32 0, i32 0
  %0 = load i32, i32* %x5, align 4
  call void @_Z4sinki(i32 noundef %0)
  %call6 = call noundef %struct.IntPair* @_ZNKSt10unique_ptrI7IntPairSt14default_deleteIS0_EEptEv(%"class.std::unique_ptr"* noundef nonnull align 8 dereferenceable(8) %mem) #10
  %y = getelementptr inbounds %struct.IntPair, %struct.IntPair* %call6, i32 0, i32 1
  %1 = load i32, i32* %y, align 4
  call void @_Z4sinki(i32 noundef %1)
  call void @_ZNSt10unique_ptrI7IntPairSt14default_deleteIS0_EED2Ev(%"class.std::unique_ptr"* noundef nonnull align 8 dereferenceable(8) %mem) #10
  ret i32 0
}
...
entry:
  ...
  %call = call noalias noundef nonnull i8* @_Znwm(i64 noundef 8) #11
  %1 = bitcast i8* %call to %struct.IntPair*
  %2 = bitcast %struct.IntPair* %1 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 8 %2, i8 0, i64 8, i1 false)
  call void @_ZNSt10unique_ptrI7IntPairSt14default_deleteIS0_EEC2IS2_vEEPS0_(%"class.std::unique_ptr"* noundef nonnull align 8 dereferenceable(8) %agg.result, %struct.IntPair* noundef %1) #10
  ret void
}
...
entry:
  ...
  %call = call noundef %struct.IntPair* @_ZNKSt10unique_ptrI7IntPairSt14default_deleteIS0_EE3getEv(%"class.std::unique_ptr"* noundef nonnull align 8 dereferenceable(8) %this1) #10
  ret %struct.IntPair* %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt10unique_ptrI7IntPairSt14default_deleteIS0_EED2Ev(%"class.std::unique_ptr"* noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::unique_ptr"*, align 8
...
if.then:                                          ; preds = %entry
  %call2 = call noundef nonnull align 1 dereferenceable(1) %"struct.std::default_delete"* @_ZNSt10unique_ptrI7IntPairSt14default_deleteIS0_EE11get_deleterEv(%"class.std::unique_ptr"* noundef nonnull align 8 dereferenceable(8) %this1) #10
  %3 = load %struct.IntPair**, %struct.IntPair*** %__ptr, align 8
  %call3 = call noundef nonnull align 8 dereferenceable(8) %struct.IntPair** @_ZSt4moveIRP7IntPairEONSt16remove_referenceIT_E4typeEOS4_(%struct.IntPair** noundef nonnull align 8 dereferenceable(8) %3) #10
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt10unique_ptrI7IntPairSt14default_deleteIS0_EEC2IS2_vEEPS0_(%"class.std::unique_ptr"* noundef nonnull align 8 dereferenceable(8) %this, %struct.IntPair* noundef %__p) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::unique_ptr"*, align 8
...
define linkonce_odr dso_local void @_ZNSt15__uniq_ptr_dataI7IntPairSt14default_deleteIS0_ELb1ELb1EECI2St15__uniq_ptr_implIS0_S2_EEPS0_(%"struct.std::__uniq_ptr_data"* noundef nonnull align 8 dereferenceable(8) %this, %struct.IntPair* noundef %0) unnamed_addr #7 comdat align 2 {
entry:
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt15__uniq_ptr_implI7IntPairSt14default_deleteIS0_EEC2EPS0_(%"class.std::__uniq_ptr_impl"* noundef nonnull align 8 dereferenceable(8) %this, %struct.IntPair* noundef %__p) unnamed_addr #7 comdat align 2 {
entry:
  ...
  call void @_ZNSt5tupleIJP7IntPairSt14default_deleteIS0_EEEC2ILb1ELb1EEEv(%"class.std::tuple"* noundef nonnull align 8 dereferenceable(8) %_M_t) #10
  %0 = load %struct.IntPair*, %struct.IntPair** %__p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt5tupleIJP7IntPairSt14default_deleteIS0_EEEC2ILb1ELb1EEEv(%"class.std::tuple"* noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
entry:
  ...
  %this1 = load %"class.std::__uniq_ptr_impl"*, %"class.std::__uniq_ptr_impl"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::__uniq_ptr_impl", %"class.std::__uniq_ptr_impl"* %this1, i32 0, i32 0
  %call = call noundef nonnull align 8 dereferenceable(8) %struct.IntPair** @_ZSt3getILm0EJP7IntPairSt14default_deleteIS0_EEERNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERS8_(%"class.std::tuple"* noundef nonnull align 8 dereferenceable(8) %_M_t) #10
  ret %struct.IntPair** %call
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt11_Tuple_implILm0EJP7IntPairSt14default_deleteIS0_EEEC2Ev(%"struct.std::_Tuple_impl"* noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #7 comdat align 2 {
entry:
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt11_Tuple_implILm1EJSt14default_deleteI7IntPairEEEC2Ev(%"struct.std::_Tuple_impl.0"* noundef nonnull align 1 dereferenceable(1) %this) unnamed_addr #7 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt10_Head_baseILm0EP7IntPairLb0EEC2Ev(%"struct.std::_Head_base.1"* noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #4 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt10_Head_baseILm1ESt14default_deleteI7IntPairELb1EEC2Ev(%"struct.std::_Head_base"* noundef nonnull align 1 dereferenceable(1) %this) unnamed_addr #4 comdat align 2 {
entry:
...
entry:
  ...
  %call = call noundef nonnull align 8 dereferenceable(8) %struct.IntPair** @_ZSt12__get_helperILm0EP7IntPairJSt14default_deleteIS0_EEERT0_RSt11_Tuple_implIXT_EJS4_DpT1_EE(%"struct.std::_Tuple_impl"* noundef nonnull align 8 dereferenceable(8) %1) #10
  ret %struct.IntPair** %call
}
...
entry:
  ...
  %call = call noundef nonnull align 8 dereferenceable(8) %struct.IntPair** @_ZNSt11_Tuple_implILm0EJP7IntPairSt14default_deleteIS0_EEE7_M_headERS4_(%"struct.std::_Tuple_impl"* noundef nonnull align 8 dereferenceable(8) %0) #10
  ret %struct.IntPair** %call
}
...
entry:
  ...
  %call = call noundef nonnull align 8 dereferenceable(8) %struct.IntPair** @_ZNSt10_Head_baseILm0EP7IntPairLb0EE7_M_headERS2_(%"struct.std::_Head_base.1"* noundef nonnull align 8 dereferenceable(8) %1) #10
  ret %struct.IntPair** %call
}
...
entry:
  ...
  %this1 = load %"class.std::__uniq_ptr_impl"*, %"class.std::__uniq_ptr_impl"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::__uniq_ptr_impl", %"class.std::__uniq_ptr_impl"* %this1, i32 0, i32 0
  %call = call noundef nonnull align 1 dereferenceable(1) %"struct.std::default_delete"* @_ZSt3getILm1EJP7IntPairSt14default_deleteIS0_EEERNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERS8_(%"class.std::tuple"* noundef nonnull align 8 dereferenceable(8) %_M_t) #10
  ret %"struct.std::default_delete"* %call
}
...
entry:
  ...
  %call = call noundef nonnull align 1 dereferenceable(1) %"struct.std::default_delete"* @_ZSt12__get_helperILm1ESt14default_deleteI7IntPairEJEERT0_RSt11_Tuple_implIXT_EJS3_DpT1_EE(%"struct.std::_Tuple_impl.0"* noundef nonnull align 1 dereferenceable(1) %1) #10
  ret %"struct.std::default_delete"* %call
}
...
entry:
  ...
  %call = call noundef nonnull align 1 dereferenceable(1) %"struct.std::default_delete"* @_ZNSt11_Tuple_implILm1EJSt14default_deleteI7IntPairEEE7_M_headERS3_(%"struct.std::_Tuple_impl.0"* noundef nonnull align 1 dereferenceable(1) %0) #10
  ret %"struct.std::default_delete"* %call
}
...
entry:
  ...
  %call = call noundef nonnull align 1 dereferenceable(1) %"struct.std::default_delete"* @_ZNSt10_Head_baseILm1ESt14default_deleteI7IntPairELb1EE7_M_headERS3_(%"struct.std::_Head_base"* noundef nonnull align 1 dereferenceable(1) %1) #10
  ret %"struct.std::default_delete"* %call
}
...
entry:
  ...
  %this1 = load %"class.std::__uniq_ptr_impl"*, %"class.std::__uniq_ptr_impl"** %this.addr, align 8
  %_M_t = getelementptr inbounds %"class.std::__uniq_ptr_impl", %"class.std::__uniq_ptr_impl"* %this1, i32 0, i32 0
  %call = call noundef nonnull align 8 dereferenceable(8) %struct.IntPair** @_ZSt3getILm0EJP7IntPairSt14default_deleteIS0_EEERKNSt13tuple_elementIXT_ESt5tupleIJDpT0_EEE4typeERKS8_(%"class.std::tuple"* noundef nonnull align 8 dereferenceable(8) %_M_t) #10
...
entry:
  ...
  %0 = load %"class.std::tuple"*, %"class.std::tuple"** %__t.addr, align 8
  %1 = bitcast %"class.std::tuple"* %0 to %"struct.std::_Tuple_impl"*
  %call = call noundef nonnull align 8 dereferenceable(8) %struct.IntPair** @_ZSt12__get_helperILm0EP7IntPairJSt14default_deleteIS0_EEERKT0_RKSt11_Tuple_implIXT_EJS4_DpT1_EE(%"struct.std::_Tuple_impl"* noundef nonnull align 8 dereferenceable(8) %1) #10
  ret %struct.IntPair** %call
}
...
entry:
  ...
  store %"struct.std::_Tuple_impl"* %__t, %"struct.std::_Tuple_impl"** %__t.addr, align 8
  %0 = load %"struct.std::_Tuple_impl"*, %"struct.std::_Tuple_impl"** %__t.addr, align 8
  %call = call noundef nonnull align 8 dereferenceable(8) %struct.IntPair** @_ZNSt11_Tuple_implILm0EJP7IntPairSt14default_deleteIS0_EEE7_M_headERKS4_(%"struct.std::_Tuple_impl"* noundef nonnull align 8 dereferenceable(8) %0) #10
  ret %struct.IntPair** %call
}
...
entry:
  ...
  %0 = load %"struct.std::_Tuple_impl"*, %"struct.std::_Tuple_impl"** %__t.addr, align 8
  %1 = bitcast %"struct.std::_Tuple_impl"* %0 to %"struct.std::_Head_base.1"*
  %call = call noundef nonnull align 8 dereferenceable(8) %struct.IntPair** @_ZNSt10_Head_baseILm0EP7IntPairLb0EE7_M_headERKS2_(%"struct.std::_Head_base.1"* noundef nonnull align 8 dereferenceable(8) %1) #10
  ret %struct.IntPair** %call
}
