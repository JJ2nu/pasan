; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/xtaint/xtaint04.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/xtaint/xtaint04.cpp"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [9 x i8] c"psr.sink\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [66 x i8] c"/home/jinu/Desktop/phasar/test/llvm_test_code/xtaint/xtaint04.cpp\00", section "llvm.metadata"
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local void @_Z3barPi(i32* noundef %arr) #0 {
entry:
  ...
  call void @_Z5printi(i32 noundef %3)
  ret void
}

; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local void @_Z3fooi(i32 noundef %x) #0 {
entry:
  ...
  %arraydecay = getelementptr inbounds [2 x i32], [2 x i32]* %array, i64 0, i64 0
  call void @_Z3barPi(i32* noundef %arraydecay)
  ret void
}
...
entry:
  ...
  call void @llvm.var.annotation(i8* %argc.addr1, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([66 x i8], [66 x i8]* @.str.1, i32 0, i32 0), i32 15, i8* null)
