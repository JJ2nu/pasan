; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/JsonConfig/fun_member_02.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/JsonConfig/fun_member_02.cpp"
...
@.str = private unnamed_addr constant [10 x i8] c"V is: %d\0A\00", align 1
...
invoke.cont3:                                     ; preds = %invoke.cont1
  ...
  %2 = load i32, i32* %V4, align 4, !dbg !241
  store i32 %2, i32* %retval, align 4, !dbg !242
  call void @_ZN1XD2Ev(%struct.X* noundef nonnull align 4 dereferenceable(4) %Y) #8, !dbg !243
  call void @_ZN1XD2Ev(%struct.X* noundef nonnull align 4 dereferenceable(4) %W) #8, !dbg !243
  call void @_ZN1XD2Ev(%struct.X* noundef nonnull align 4 dereferenceable(4) %V) #8, !dbg !243
  %3 = load i32, i32* %retval, align 4, !dbg !243
  ret i32 %3, !dbg !243

lpad:                                             ; preds = %invoke.cont, %entry
  %4 = landingpad { i8*, i32 }
          cleanup, !dbg !243
  %5 = extractvalue { i8*, i32 } %4, 0, !dbg !243
  store i8* %5, i8** %exn.slot, align 8, !dbg !243
  %6 = extractvalue { i8*, i32 } %4, 1, !dbg !243
  store i32 %6, i32* %ehselector.slot, align 4, !dbg !243
...
entry:
  ...
  store i32 %0, i32* %V2, align 4, !dbg !250
  ret void, !dbg !252
}
...
entry:
  ...
  %0 = load i32, i32* %V, align 4, !dbg !258
  %call = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 noundef %0), !dbg !259
  ret void, !dbg !260
}
...
entry:
  ...
  %0 = load i32, i32* %V, align 4, !dbg !264
  %call = invoke i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 noundef %0)
...
terminate.lpad:                                   ; preds = %entry
  ...
  %2 = extractvalue { i8*, i32 } %1, 0, !dbg !266
  call void @__clang_call_terminate(i8* %2) #9, !dbg !266
  unreachable, !dbg !266
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/JsonConfig/fun_member_02.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/TaintConfig/JsonConfig", checksumkind: CSK_MD5, checksum: "c029c05adb5c3b4d2111020303cc9933")
!2 = !{!3}
...
!4 = !DIFile(filename: "test/llvm_test_code/TaintConfig/JsonConfig/fun_member_02.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "c029c05adb5c3b4d2111020303cc9933")
...
!193 = !DIFile(filename: "test/llvm_test_code/TaintConfig/JsonConfig/fun_member_02.cpp", directory: "/home/jinu/Desktop/phasar")
...
!258 = !DILocation(line: 8, column: 39, scope: !255)
!259 = !DILocation(line: 8, column: 18, scope: !255)
!260 = !DILocation(line: 8, column: 43, scope: !255)
...
!264 = !DILocation(line: 7, column: 31, scope: !265)
!265 = distinct !DILexicalBlock(scope: !261, file: !4, line: 7, column: 8)
!266 = !DILocation(line: 7, column: 10, scope: !265)
!267 = !DILocation(line: 7, column: 35, scope: !261)
