; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/basic_01.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/basic_01.c"
...
@.str.1 = private unnamed_addr constant [80 x i8] c"/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/basic_01.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [11 x i8] c"psr.source\00", section "llvm.metadata"
@llvm.global.annotations = appending global [1 x { i8*, i8*, i8*, i32, i8* }] [{ i8*, i8*, i8*, i32, i8* } { i8* bitcast (i32 ()* @bar to i8*), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([80 x i8], [80 x i8]* @.str.1, i32 0, i32 0), i32 5, i8* null }], section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %B.addr1, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([80 x i8], [80 x i8]* @.str.1, i32 0, i32 0), i32 3, i8* null)
  ret i32 0, !dbg !18
}
...
entry:
  ...
  %B.addr1 = bitcast i32* %B.addr to i8*
  call void @llvm.var.annotation(i8* %B.addr1, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([80 x i8], [80 x i8]* @.str.1, i32 0, i32 0), i32 7, i8* null)
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/basic_01.c", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/TaintConfig/AttrConfig", checksumkind: CSK_MD5, checksum: "e917c7035a86804600b14be382ee94ac")
...
!9 = !DIFile(filename: "test/llvm_test_code/TaintConfig/AttrConfig/basic_01.c", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "e917c7035a86804600b14be382ee94ac")
...
!17 = !DILocation(line: 3, column: 58, scope: !8)
!18 = !DILocation(line: 3, column: 63, scope: !8)
...
!21 = !{!12}
!22 = !DILocation(line: 5, column: 53, scope: !19)
...
!29 = !DILocation(line: 7, column: 58, scope: !23)
!30 = !DILocalVariable(name: "C", arg: 3, scope: !23, file: !9, line: 7, type: !12)
!31 = !DILocation(line: 7, column: 65, scope: !23)
!32 = !DILocation(line: 7, column: 70, scope: !23)
...
!47 = !DIFile(filename: "test/llvm_test_code/TaintConfig/AttrConfig/basic_01.c", directory: "/home/jinu/Desktop/phasar")
