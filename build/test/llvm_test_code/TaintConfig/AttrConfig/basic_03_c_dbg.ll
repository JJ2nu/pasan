; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/basic_03.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/basic_03.c"
...
@.str.1 = private unnamed_addr constant [80 x i8] c"/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/basic_03.c\00", section "llvm.metadata"
@llvm.global.annotations = appending global [1 x { i8*, i8*, i8*, i32, i8* }] [{ i8*, i8*, i8*, i32, i8* } { i8* bitcast (%struct.Pair_t* (%struct.Pair_t*)* @taintPair to i8*), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([80 x i8], [80 x i8]* @.str.1, i32 0, i32 0), i32 14, i8* null }], section "llvm.metadata"
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/basic_03.c", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/TaintConfig/AttrConfig", checksumkind: CSK_MD5, checksum: "906b7e327d7d40aac0e138ba229f9978")
...
!9 = !DIFile(filename: "test/llvm_test_code/TaintConfig/AttrConfig/basic_03.c", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "906b7e327d7d40aac0e138ba229f9978")
...
!31 = !DILocation(line: 14, column: 63, scope: !26)
