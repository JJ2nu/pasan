; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/data_member_01.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/data_member_01.cpp"
...
@.str.1 = private unnamed_addr constant [88 x i8] c"/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/data_member_01.cpp\00", section "llvm.metadata"
...
entry:
  ...
  call void @_ZN1XC2Ev(%struct.X* noundef nonnull align 4 dereferenceable(8) %V) #4, !dbg !20
  ...
  %1 = call i8* @llvm.ptr.annotation.p0i8(i8* %0, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([88 x i8], [88 x i8]* @.str.1, i32 0, i32 0), i32 3, i8* null), !dbg !23
  %2 = bitcast i8* %1 to i32*, !dbg !23
  %3 = load i32, i32* %2, align 4, !dbg !23
  %B1 = getelementptr inbounds %struct.X, %struct.X* %V, i32 0, i32 1, !dbg !24
  %4 = load i32, i32* %B1, align 4, !dbg !24
  %add = add nsw i32 %3, %4, !dbg !25
  ret i32 %add, !dbg !26
}
...
entry:
  ...
  %0 = bitcast i32* %A to i8*, !dbg !35
  %1 = call i8* @llvm.ptr.annotation.p0i8(i8* %0, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([88 x i8], [88 x i8]* @.str.1, i32 0, i32 0), i32 3, i8* null), !dbg !35
  %2 = bitcast i8* %1 to i32*, !dbg !35
  store i32 13, i32* %2, align 4, !dbg !35
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/data_member_01.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/TaintConfig/AttrConfig", checksumkind: CSK_MD5, checksum: "fcc7f83745054f8e8b49d91f12f02873")
!2 = !{!3}
...
!4 = !DIFile(filename: "test/llvm_test_code/TaintConfig/AttrConfig/data_member_01.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "fcc7f83745054f8e8b49d91f12f02873")
!5 = !{!6, !8}
...
!35 = !DILocation(line: 3, column: 41, scope: !27)
