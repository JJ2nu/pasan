; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/array_02.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/array_02.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [11 x i8] c"psr.source\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [80 x i8] c"/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/array_02.c\00", section "llvm.metadata"
...
entry:
  ...
  %call = call noalias i8* @malloc(i64 noundef 128) #4, !dbg !19
...
for.end:                                          ; preds = %for.cond
  ...
  %P2 = bitcast i8** %P to i8*, !dbg !42
  call void @llvm.var.annotation(i8* %P2, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([80 x i8], [80 x i8]* @.str.1, i32 0, i32 0), i32 9, i8* null), !dbg !42
  %5 = load i8*, i8** %Buffer, align 8, !dbg !43
  %arrayidx3 = getelementptr inbounds i8, i8* %5, i64 42, !dbg !43
  store i8* %arrayidx3, i8** %P, align 8, !dbg !41
  %6 = load i8*, i8** %Buffer, align 8, !dbg !44
  call void @free(i8* noundef %6) #4, !dbg !45
  ret i32 0, !dbg !46
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/array_02.c", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/TaintConfig/AttrConfig", checksumkind: CSK_MD5, checksum: "10876bd96503da642f0277b41a7fa4d2")
!2 = !{!3}
...
!12 = !DIFile(filename: "test/llvm_test_code/TaintConfig/AttrConfig/array_02.c", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "10876bd96503da642f0277b41a7fa4d2")
...
!41 = !DILocation(line: 9, column: 49, scope: !11)
!42 = !DILocation(line: 9, column: 3, scope: !11)
!43 = !DILocation(line: 9, column: 54, scope: !11)
!44 = !DILocation(line: 10, column: 8, scope: !11)
