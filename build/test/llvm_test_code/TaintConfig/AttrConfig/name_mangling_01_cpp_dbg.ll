; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/name_mangling_01.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/name_mangling_01.cpp"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [11 x i8] c"psr.source\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [90 x i8] c"/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/name_mangling_01.cpp\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %A.addr1, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i32 0, i32 0), i32 6, i8* null)
...
entry:
  ...
  %D.addr1 = bitcast i32* %D.addr to i8*
  call void @llvm.var.annotation(i8* %D.addr1, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i32 0, i32 0), i32 10, i8* null)
  ret void, !dbg !50
}

; Function Attrs: mustprogress noinline norecurse nounwind optnone uwtable
define dso_local noundef i32 @main() #3 !dbg !51 {
entry:
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/TaintConfig/AttrConfig/name_mangling_01.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/TaintConfig/AttrConfig", checksumkind: CSK_MD5, checksum: "4775ef0ea1bee19bd43c81592aa17873")
...
!9 = !DIFile(filename: "test/llvm_test_code/TaintConfig/AttrConfig/name_mangling_01.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "4775ef0ea1bee19bd43c81592aa17873")
...
!25 = !DILocation(line: 6, column: 48, scope: !21)
!26 = !DILocalVariable(name: "B", arg: 2, scope: !21, file: !9, line: 6, type: !17)
!27 = !DILocation(line: 6, column: 55, scope: !21)
!28 = !DILocation(line: 6, column: 59, scope: !21)
...
!49 = !DILocation(line: 10, column: 69, scope: !39)
!50 = !DILocation(line: 10, column: 73, scope: !39)
