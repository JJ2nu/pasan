...
entry:
  ...
  %add = add nsw i32 %0, 20, !dbg !19
  store i32 %add, i32* %i, align 4, !dbg !17
  %1 = load i8, i8* @cond, align 1, !dbg !20
  %tobool = trunc i8 %1 to i1, !dbg !20
  br i1 %tobool, label %if.then, label %if.end, !dbg !22

if.then:                                          ; preds = %entry
  %2 = load i32, i32* %j, align 4, !dbg !23
  %add1 = add nsw i32 %2, 20, !dbg !25
  store i32 %add1, i32* %i, align 4, !dbg !26
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/linear_constant/branch_07.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/linear_constant", checksumkind: CSK_MD5, checksum: "1aea92f3978df34523baa89cda756fc3")
...
!9 = !DIFile(filename: "test/llvm_test_code/linear_constant/branch_07.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "1aea92f3978df34523baa89cda756fc3")
...
!21 = distinct !DILexicalBlock(scope: !8, file: !9, line: 5, column: 7)
!22 = !DILocation(line: 5, column: 7, scope: !8)
!23 = !DILocation(line: 6, column: 9, scope: !24)
!24 = distinct !DILexicalBlock(scope: !21, file: !9, line: 5, column: 13)
!25 = !DILocation(line: 6, column: 11, scope: !24)
!26 = !DILocation(line: 6, column: 7, scope: !24)
!27 = !DILocation(line: 7, column: 3, scope: !24)
!28 = !DILocation(line: 8, column: 3, scope: !8)
