; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/linear_constant/call_09.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/linear_constant/call_09.cpp"
...
entry:
  ...
  %call = call noundef i32 @_Z9incrementi(i32 noundef 42), !dbg !23
  store i32 %call, i32* %i, align 4, !dbg !22
  call void @llvm.dbg.declare(metadata i32* %j, metadata !24, metadata !DIExpression()), !dbg !25
  %call1 = call noundef i32 @_Z9incrementi(i32 noundef 42), !dbg !26
  store i32 %call1, i32* %j, align 4, !dbg !25
  ret i32 0, !dbg !27
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/linear_constant/call_09.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/linear_constant", checksumkind: CSK_MD5, checksum: "4d89f1b8bae4b759b472b5fec0a02634")
...
!9 = !DIFile(filename: "test/llvm_test_code/linear_constant/call_09.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "4d89f1b8bae4b759b472b5fec0a02634")
...
!16 = !DILocation(line: 2, column: 11, scope: !8)
!17 = !DILocation(line: 2, column: 4, scope: !8)
...
!23 = !DILocation(line: 6, column: 11, scope: !18)
!24 = !DILocalVariable(name: "j", scope: !18, file: !9, line: 7, type: !12)
!25 = !DILocation(line: 7, column: 7, scope: !18)
!26 = !DILocation(line: 7, column: 11, scope: !18)
!27 = !DILocation(line: 8, column: 3, scope: !18)
