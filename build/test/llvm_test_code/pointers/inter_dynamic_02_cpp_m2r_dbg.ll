; ModuleID = 'inter_dynamic_02_cpp_m2r_dbg.ll'
...
entry:
  ...
  store i32 42, i32* %0, align 4, !dbg !236
  %1 = bitcast i32* %0 to i8*, !dbg !237
  call void @free(i8* noundef %1) #4, !dbg !238
  ret i32 0, !dbg !239
}
...
!236 = !DILocation(line: 9, column: 6, scope: !230)
!237 = !DILocation(line: 10, column: 8, scope: !230)
!238 = !DILocation(line: 10, column: 3, scope: !230)
!239 = !DILocation(line: 11, column: 1, scope: !230)
