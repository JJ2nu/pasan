; ModuleID = 'dynamic_01_cpp_m2r_dbg.ll'
...
entry:
  %call = call noalias i8* @malloc(i64 noundef 4) #3, !dbg !224
  %0 = bitcast i8* %call to i32*, !dbg !225
  call void @llvm.dbg.value(metadata i32* %0, metadata !226, metadata !DIExpression()), !dbg !227
  store i32 13, i32* %0, align 4, !dbg !228
  %1 = bitcast i32* %0 to i8*, !dbg !229
  call void @free(i8* noundef %1) #3, !dbg !230
  ret i32 0, !dbg !231
}
...
!223 = !{}
!224 = !DILocation(line: 5, column: 31, scope: !221)
!225 = !DILocation(line: 5, column: 12, scope: !221)
!226 = !DILocalVariable(name: "p", scope: !221, file: !222, line: 5, type: !3)
!227 = !DILocation(line: 0, scope: !221)
!228 = !DILocation(line: 6, column: 6, scope: !221)
!229 = !DILocation(line: 7, column: 8, scope: !221)
!230 = !DILocation(line: 7, column: 3, scope: !221)
!231 = !DILocation(line: 8, column: 1, scope: !221)
