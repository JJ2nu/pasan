...
define dso_local noundef i32 @main() #0 !dbg !221 {
entry:
  %p = alloca i32*, align 8
  call void @llvm.dbg.declare(metadata i32** %p, metadata !224, metadata !DIExpression()), !dbg !225
  %call = call noalias i8* @malloc(i64 noundef 4) #3, !dbg !226
  %0 = bitcast i8* %call to i32*, !dbg !227
  store i32* %0, i32** %p, align 8, !dbg !225
  %1 = load i32*, i32** %p, align 8, !dbg !228
  store i32 13, i32* %1, align 4, !dbg !229
  %2 = load i32*, i32** %p, align 8, !dbg !230
  %3 = bitcast i32* %2 to i8*, !dbg !230
  call void @free(i8* noundef %3) #3, !dbg !231
  ret i32 0, !dbg !232
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/pointers/dynamic_01.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/pointers", checksumkind: CSK_MD5, checksum: "18bda9c2d26c160fe19bb7a63372179b")
!2 = !{!3}
...
!221 = distinct !DISubprogram(name: "main", scope: !222, file: !222, line: 4, type: !124, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !223)
!222 = !DIFile(filename: "test/llvm_test_code/pointers/dynamic_01.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "18bda9c2d26c160fe19bb7a63372179b")
!223 = !{}
!224 = !DILocalVariable(name: "p", scope: !221, file: !222, line: 5, type: !3)
!225 = !DILocation(line: 5, column: 8, scope: !221)
!226 = !DILocation(line: 5, column: 31, scope: !221)
!227 = !DILocation(line: 5, column: 12, scope: !221)
!228 = !DILocation(line: 6, column: 4, scope: !221)
!229 = !DILocation(line: 6, column: 6, scope: !221)
!230 = !DILocation(line: 7, column: 8, scope: !221)
!231 = !DILocation(line: 7, column: 3, scope: !221)
!232 = !DILocation(line: 8, column: 1, scope: !221)
