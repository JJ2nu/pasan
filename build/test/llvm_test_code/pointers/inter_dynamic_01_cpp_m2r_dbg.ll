; ModuleID = 'inter_dynamic_01_cpp_m2r_dbg.ll'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/pointers/inter_dynamic_01.cpp"
...
entry:
  call void @llvm.dbg.value(metadata i32* %p, metadata !226, metadata !DIExpression()), !dbg !227
  store i32 13, i32* %p, align 4, !dbg !228
  ret void, !dbg !229
}
...
define dso_local noundef i32 @main() #2 !dbg !230 {
entry:
  %call = call noalias i8* @malloc(i64 noundef 4) #4, !dbg !231
  %0 = bitcast i8* %call to i32*, !dbg !232
  call void @llvm.dbg.value(metadata i32* %0, metadata !233, metadata !DIExpression()), !dbg !234
  call void @_Z4initPi(i32* noundef %0), !dbg !235
  %1 = bitcast i32* %0 to i8*, !dbg !236
  call void @free(i8* noundef %1) #4, !dbg !237
  ret i32 0, !dbg !238
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/pointers/inter_dynamic_01.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/pointers", checksumkind: CSK_MD5, checksum: "120ee081b50e5ab80033410b5bf239f4")
!2 = !{!3}
...
!15 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !9, line: 59, size: 64, flags: DIFlagFwdDecl, identifier: "_ZTS5div_t")
...
!222 = !DIFile(filename: "test/llvm_test_code/pointers/inter_dynamic_01.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "120ee081b50e5ab80033410b5bf239f4")
!223 = !DISubroutineType(types: !224)
!224 = !{null, !3}
!225 = !{}
!226 = !DILocalVariable(name: "p", arg: 1, scope: !221, file: !222, line: 4, type: !3)
!227 = !DILocation(line: 0, scope: !221)
!228 = !DILocation(line: 4, column: 24, scope: !221)
!229 = !DILocation(line: 4, column: 30, scope: !221)
!230 = distinct !DISubprogram(name: "main", scope: !222, file: !222, line: 6, type: !124, scopeLine: 6, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !225)
!231 = !DILocation(line: 7, column: 31, scope: !230)
!232 = !DILocation(line: 7, column: 12, scope: !230)
!233 = !DILocalVariable(name: "p", scope: !230, file: !222, line: 7, type: !3)
!234 = !DILocation(line: 0, scope: !230)
!235 = !DILocation(line: 8, column: 3, scope: !230)
!236 = !DILocation(line: 9, column: 8, scope: !230)
!237 = !DILocation(line: 9, column: 3, scope: !230)
!238 = !DILocation(line: 10, column: 1, scope: !230)
