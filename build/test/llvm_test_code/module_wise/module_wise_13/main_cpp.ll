; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/module_wise/module_wise_13/main.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/module_wise/module_wise_13/main.cpp"
...
@_ZTV1B = external dso_local unnamed_addr constant { [5 x i8*] }, align 8
@_ZTV1A = external dso_local unnamed_addr constant { [5 x i8*] }, align 8
...
entry:
  ...
  call void @_ZN1BC2Ev(%struct.B* noundef nonnull align 8 dereferenceable(8) %b) #3
  %call = call noundef i32 @_ZN1B3fooERi(%struct.B* noundef nonnull align 8 dereferenceable(8) %b, i32* noundef nonnull align 4 dereferenceable(4) %k)
