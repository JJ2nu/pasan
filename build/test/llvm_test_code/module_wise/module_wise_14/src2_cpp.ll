; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/module_wise/module_wise_14/src2.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/module_wise/module_wise_14/src2.cpp"
...
@_ZTV1B = dso_local unnamed_addr constant { [4 x i8*] } { [4 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI1B to i8*), i8* bitcast (i32 (%struct.B*, i32*)* @_ZN1B3fooERi to i8*), i8* bitcast (void (%struct.A*, double*)* @_ZN1A3barERd to i8*)] }, align 8
