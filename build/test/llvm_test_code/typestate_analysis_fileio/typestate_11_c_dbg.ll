; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_11.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_11.c"
...
define dso_local void @bar(%struct._IO_FILE* noundef %p) #0 !dbg !8 {
entry:
  ...
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %p.addr, align 8, !dbg !78
  %call = call i32 @fclose(%struct._IO_FILE* noundef %0), !dbg !79
  ret void, !dbg !80
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @foo(%struct._IO_FILE* noundef %p) #0 !dbg !81 {
entry:
  %p.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %p, %struct._IO_FILE** %p.addr, align 8
  call void @llvm.dbg.declare(metadata %struct._IO_FILE** %p.addr, metadata !82, metadata !DIExpression()), !dbg !83
  %call = call noalias %struct._IO_FILE* @fopen(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0)), !dbg !84
  store %struct._IO_FILE* %call, %struct._IO_FILE** %p.addr, align 8, !dbg !85
  ret void, !dbg !86
}
...
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct._IO_FILE** %f, metadata !90, metadata !DIExpression()), !dbg !91
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !92
  call void @foo(%struct._IO_FILE* noundef %0), !dbg !93
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !94
  call void @bar(%struct._IO_FILE* noundef %1), !dbg !95
  ret i32 0, !dbg !96
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_11.c", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/typestate_analysis_fileio", checksumkind: CSK_MD5, checksum: "fa99bf25654500b28cd5b8557d5a7f67")
...
!8 = distinct !DISubprogram(name: "bar", scope: !9, file: !9, line: 4, type: !10, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !75)
!9 = !DIFile(filename: "test/llvm_test_code/typestate_analysis_fileio/typestate_11.c", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "fa99bf25654500b28cd5b8557d5a7f67")
...
!78 = !DILocation(line: 4, column: 28, scope: !8)
!79 = !DILocation(line: 4, column: 21, scope: !8)
!80 = !DILocation(line: 4, column: 32, scope: !8)
!81 = distinct !DISubprogram(name: "foo", scope: !9, file: !9, line: 6, type: !10, scopeLine: 6, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !75)
!82 = !DILocalVariable(name: "p", arg: 1, scope: !81, file: !9, line: 6, type: !12)
!83 = !DILocation(line: 6, column: 16, scope: !81)
!84 = !DILocation(line: 6, column: 25, scope: !81)
!85 = !DILocation(line: 6, column: 23, scope: !81)
!86 = !DILocation(line: 6, column: 49, scope: !81)
!87 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 8, type: !88, scopeLine: 8, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !75)
!88 = !DISubroutineType(types: !89)
!89 = !{!19}
!90 = !DILocalVariable(name: "f", scope: !87, file: !9, line: 9, type: !12)
!91 = !DILocation(line: 9, column: 9, scope: !87)
!92 = !DILocation(line: 10, column: 7, scope: !87)
!93 = !DILocation(line: 10, column: 3, scope: !87)
!94 = !DILocation(line: 11, column: 7, scope: !87)
!95 = !DILocation(line: 11, column: 3, scope: !87)
!96 = !DILocation(line: 13, column: 3, scope: !87)
