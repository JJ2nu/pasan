; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_10.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_10.c"
...
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct._IO_FILE** %fp, metadata !76, metadata !DIExpression()), !dbg !77
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %fp, align 8, !dbg !78
  ret %struct._IO_FILE* %0, !dbg !79
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @foo() #0 !dbg !80 {
entry:
  %p = alloca %struct._IO_FILE*, align 8
  call void @llvm.dbg.declare(metadata %struct._IO_FILE** %p, metadata !81, metadata !DIExpression()), !dbg !82
  %call = call %struct._IO_FILE* @bar(), !dbg !83
  store %struct._IO_FILE* %call, %struct._IO_FILE** %p, align 8, !dbg !82
  %call1 = call noalias %struct._IO_FILE* @fopen(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0)), !dbg !84
  store %struct._IO_FILE* %call1, %struct._IO_FILE** %p, align 8, !dbg !85
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %p, align 8, !dbg !86
  ret %struct._IO_FILE* %0, !dbg !87
}
...
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct._IO_FILE** %f, metadata !91, metadata !DIExpression()), !dbg !92
  %call = call %struct._IO_FILE* @foo(), !dbg !93
  store %struct._IO_FILE* %call, %struct._IO_FILE** %f, align 8, !dbg !94
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !95
  %call1 = call i32 @fclose(%struct._IO_FILE* noundef %0), !dbg !96
  ret i32 0, !dbg !97
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_10.c", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/typestate_analysis_fileio", checksumkind: CSK_MD5, checksum: "c0c14eda88c8e7f3695f757f06e26de9")
...
!9 = !DIFile(filename: "test/llvm_test_code/typestate_analysis_fileio/typestate_10.c", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "c0c14eda88c8e7f3695f757f06e26de9")
...
!75 = !{}
!76 = !DILocalVariable(name: "fp", scope: !8, file: !9, line: 5, type: !12)
!77 = !DILocation(line: 5, column: 9, scope: !8)
!78 = !DILocation(line: 6, column: 10, scope: !8)
!79 = !DILocation(line: 6, column: 3, scope: !8)
!80 = distinct !DISubprogram(name: "foo", scope: !9, file: !9, line: 9, type: !10, scopeLine: 9, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !75)
!81 = !DILocalVariable(name: "p", scope: !80, file: !9, line: 10, type: !12)
!82 = !DILocation(line: 10, column: 9, scope: !80)
!83 = !DILocation(line: 10, column: 13, scope: !80)
!84 = !DILocation(line: 11, column: 7, scope: !80)
!85 = !DILocation(line: 11, column: 5, scope: !80)
!86 = !DILocation(line: 12, column: 10, scope: !80)
!87 = !DILocation(line: 12, column: 3, scope: !80)
!88 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 15, type: !89, scopeLine: 15, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !75)
!89 = !DISubroutineType(types: !90)
!90 = !{!19}
!91 = !DILocalVariable(name: "f", scope: !88, file: !9, line: 16, type: !12)
!92 = !DILocation(line: 16, column: 9, scope: !88)
!93 = !DILocation(line: 17, column: 7, scope: !88)
!94 = !DILocation(line: 17, column: 5, scope: !88)
!95 = !DILocation(line: 18, column: 10, scope: !88)
!96 = !DILocation(line: 18, column: 3, scope: !88)
