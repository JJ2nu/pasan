; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_09.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_09.c"
...
@.str.3 = private unnamed_addr constant [9 x i8] c"Life is \00", align 1

; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @foo() #0 !dbg !8 {
entry:
...
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct._IO_FILE** %f, metadata !85, metadata !DIExpression()), !dbg !86
  %call = call %struct._IO_FILE* @foo(), !dbg !87
  store %struct._IO_FILE* %call, %struct._IO_FILE** %f, align 8, !dbg !88
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !89
  %call1 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %0, i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 noundef 42), !dbg !90
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !91
  %call2 = call i32 @fclose(%struct._IO_FILE* noundef %1), !dbg !92
  ret i32 0, !dbg !93
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_09.c", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/typestate_analysis_fileio", checksumkind: CSK_MD5, checksum: "70c97072d36332bd734994409755c7b5")
...
!8 = distinct !DISubprogram(name: "foo", scope: !9, file: !9, line: 4, type: !10, scopeLine: 4, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !75)
!9 = !DIFile(filename: "test/llvm_test_code/typestate_analysis_fileio/typestate_09.c", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "70c97072d36332bd734994409755c7b5")
...
!82 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 10, type: !83, scopeLine: 10, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !75)
!83 = !DISubroutineType(types: !84)
!84 = !{!19}
!85 = !DILocalVariable(name: "f", scope: !82, file: !9, line: 11, type: !12)
!86 = !DILocation(line: 11, column: 9, scope: !82)
!87 = !DILocation(line: 12, column: 7, scope: !82)
!88 = !DILocation(line: 12, column: 5, scope: !82)
!89 = !DILocation(line: 13, column: 11, scope: !82)
!90 = !DILocation(line: 13, column: 3, scope: !82)
!91 = !DILocation(line: 14, column: 10, scope: !82)
!92 = !DILocation(line: 14, column: 3, scope: !82)
!93 = !DILocation(line: 15, column: 3, scope: !82)
