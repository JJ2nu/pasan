; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_05.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_05.c"
...
entry:
  ...
  %call = call noalias %struct._IO_FILE* @fopen(i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)), !dbg !78
  store %struct._IO_FILE* %call, %struct._IO_FILE** %f, align 8, !dbg !79
  %0 = load i32, i32* @cond, align 4, !dbg !80
  %tobool = icmp ne i32 %0, 0, !dbg !80
  br i1 %tobool, label %if.then, label %if.end, !dbg !82

if.then:                                          ; preds = %entry
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !83
  %call1 = call i32 @fclose(%struct._IO_FILE* noundef %1), !dbg !85
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_05.c", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/typestate_analysis_fileio", checksumkind: CSK_MD5, checksum: "4b1396d2806f7d0ee0f782cf9754d106")
...
!9 = !DIFile(filename: "test/llvm_test_code/typestate_analysis_fileio/typestate_05.c", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "4b1396d2806f7d0ee0f782cf9754d106")
!10 = !DISubroutineType(types: !11)
!11 = !{!12}
!12 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!13 = !{}
!14 = !DILocalVariable(name: "f", scope: !8, file: !9, line: 6, type: !15)
...
!77 = !DILocation(line: 6, column: 9, scope: !8)
!78 = !DILocation(line: 7, column: 7, scope: !8)
!79 = !DILocation(line: 7, column: 5, scope: !8)
!80 = !DILocation(line: 8, column: 7, scope: !81)
!81 = distinct !DILexicalBlock(scope: !8, file: !9, line: 8, column: 7)
!82 = !DILocation(line: 8, column: 7, scope: !8)
!83 = !DILocation(line: 9, column: 12, scope: !84)
!84 = distinct !DILexicalBlock(scope: !81, file: !9, line: 8, column: 13)
!85 = !DILocation(line: 9, column: 5, scope: !84)
!86 = !DILocation(line: 10, column: 3, scope: !84)
!87 = !DILocation(line: 11, column: 3, scope: !8)
