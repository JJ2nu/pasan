; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_16.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_16.c"
...
while.body:                                       ; preds = %while.cond
  ...
  %call1 = call i32 @putchar(i32 noundef %1), !dbg !86
  br label %while.cond, !dbg !80, !llvm.loop !87

while.end:                                        ; preds = %while.cond
  %2 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8, !dbg !90
  %call2 = call i32 @fclose(%struct._IO_FILE* noundef %2), !dbg !91
  ret void, !dbg !92
}
...
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct._IO_FILE** %f, metadata !96, metadata !DIExpression()), !dbg !97
  %call = call noalias %struct._IO_FILE* @fopen(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)), !dbg !98
  store %struct._IO_FILE* %call, %struct._IO_FILE** %f, align 8, !dbg !99
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !100
  call void @foo(%struct._IO_FILE* noundef %0), !dbg !101
  ret i32 0, !dbg !102
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_16.c", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/typestate_analysis_fileio", checksumkind: CSK_MD5, checksum: "c72149cce093d46e175e5459de419174")
...
!9 = !DIFile(filename: "test/llvm_test_code/typestate_analysis_fileio/typestate_16.c", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "c72149cce093d46e175e5459de419174")
...
!85 = !DILocation(line: 8, column: 13, scope: !8)
!86 = !DILocation(line: 8, column: 5, scope: !8)
!87 = distinct !{!87, !80, !88, !89}
!88 = !DILocation(line: 8, column: 14, scope: !8)
!89 = !{!"llvm.loop.mustprogress"}
!90 = !DILocation(line: 10, column: 10, scope: !8)
!91 = !DILocation(line: 10, column: 3, scope: !8)
!92 = !DILocation(line: 11, column: 1, scope: !8)
!93 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 13, type: !94, scopeLine: 13, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !75)
!94 = !DISubroutineType(types: !95)
!95 = !{!19}
!96 = !DILocalVariable(name: "f", scope: !93, file: !9, line: 14, type: !12)
!97 = !DILocation(line: 14, column: 9, scope: !93)
!98 = !DILocation(line: 15, column: 7, scope: !93)
!99 = !DILocation(line: 15, column: 5, scope: !93)
!100 = !DILocation(line: 17, column: 7, scope: !93)
!101 = !DILocation(line: 17, column: 3, scope: !93)
!102 = !DILocation(line: 19, column: 3, scope: !93)
