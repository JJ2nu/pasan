; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_17.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_17.c"
...
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct._IO_FILE** %f, metadata !86, metadata !DIExpression()), !dbg !87
  %call = call noalias %struct._IO_FILE* @fopen(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)), !dbg !88
  store %struct._IO_FILE* %call, %struct._IO_FILE** %f, align 8, !dbg !89
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !90
  call void @foo(%struct._IO_FILE* noundef %0), !dbg !91
  br label %while.cond, !dbg !92

while.cond:                                       ; preds = %while.body, %entry
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !93
  %call1 = call i32 @fgetc(%struct._IO_FILE* noundef %1), !dbg !94
  store i32 %call1, i32* %i, align 4, !dbg !95
  %cmp = icmp ne i32 %call1, -1, !dbg !96
  br i1 %cmp, label %while.body, label %while.end, !dbg !92

while.body:                                       ; preds = %while.cond
  br label %while.cond, !dbg !92, !llvm.loop !97
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_17.c", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/typestate_analysis_fileio", checksumkind: CSK_MD5, checksum: "0c529cced466c4b53d31c74a2f74f3d8")
...
!9 = !DIFile(filename: "test/llvm_test_code/typestate_analysis_fileio/typestate_17.c", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "0c529cced466c4b53d31c74a2f74f3d8")
...
!83 = !{!19}
!84 = !DILocalVariable(name: "i", scope: !81, file: !9, line: 7, type: !19)
!85 = !DILocation(line: 7, column: 7, scope: !81)
!86 = !DILocalVariable(name: "f", scope: !81, file: !9, line: 8, type: !12)
!87 = !DILocation(line: 8, column: 9, scope: !81)
!88 = !DILocation(line: 10, column: 7, scope: !81)
!89 = !DILocation(line: 10, column: 5, scope: !81)
!90 = !DILocation(line: 12, column: 7, scope: !81)
!91 = !DILocation(line: 12, column: 3, scope: !81)
!92 = !DILocation(line: 14, column: 3, scope: !81)
!93 = !DILocation(line: 14, column: 21, scope: !81)
!94 = !DILocation(line: 14, column: 15, scope: !81)
!95 = !DILocation(line: 14, column: 13, scope: !81)
!96 = !DILocation(line: 14, column: 25, scope: !81)
!97 = distinct !{!97, !92, !98, !99}
!98 = !DILocation(line: 15, column: 3, scope: !81)
!99 = !{!"llvm.loop.mustprogress"}
!100 = !DILocation(line: 17, column: 3, scope: !81)
