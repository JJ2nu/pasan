; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_06.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_06.c"
...
entry:
  ...
  %d = alloca %struct._IO_FILE*, align 8
  store i32 0, i32* %retval, align 4
  call void @llvm.dbg.declare(metadata %struct._IO_FILE** %f, metadata !14, metadata !DIExpression()), !dbg !77
  call void @llvm.dbg.declare(metadata %struct._IO_FILE** %d, metadata !78, metadata !DIExpression()), !dbg !79
  %call = call noalias %struct._IO_FILE* @fopen(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)), !dbg !80
  store %struct._IO_FILE* %call, %struct._IO_FILE** %f, align 8, !dbg !81
  %call1 = call noalias %struct._IO_FILE* @fopen(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)), !dbg !82
  store %struct._IO_FILE* %call1, %struct._IO_FILE** %d, align 8, !dbg !83
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !84
  %call2 = call i32 @fclose(%struct._IO_FILE* noundef %0), !dbg !85
  ret i32 0, !dbg !86
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_06.c", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/typestate_analysis_fileio", checksumkind: CSK_MD5, checksum: "9dcf4062bc64b5e671c82d74205fb68d")
...
!8 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 4, type: !10, scopeLine: 4, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !13)
!9 = !DIFile(filename: "test/llvm_test_code/typestate_analysis_fileio/typestate_06.c", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "9dcf4062bc64b5e671c82d74205fb68d")
!10 = !DISubroutineType(types: !11)
!11 = !{!12}
!12 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!13 = !{}
!14 = !DILocalVariable(name: "f", scope: !8, file: !9, line: 5, type: !15)
...
!78 = !DILocalVariable(name: "d", scope: !8, file: !9, line: 6, type: !15)
!79 = !DILocation(line: 6, column: 9, scope: !8)
!80 = !DILocation(line: 7, column: 7, scope: !8)
!81 = !DILocation(line: 7, column: 5, scope: !8)
!82 = !DILocation(line: 8, column: 7, scope: !8)
!83 = !DILocation(line: 8, column: 5, scope: !8)
!84 = !DILocation(line: 10, column: 10, scope: !8)
!85 = !DILocation(line: 10, column: 3, scope: !8)
!86 = !DILocation(line: 12, column: 3, scope: !8)
