; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_03.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_03.c"
...
entry:
  ...
  %call = call noalias %struct._IO_FILE* @fopen(i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)), !dbg !86
  store %struct._IO_FILE* %call, %struct._IO_FILE** %f, align 8, !dbg !87
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !88
  call void @foo(%struct._IO_FILE* noundef %0), !dbg !89
  ret i32 0, !dbg !90
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_03.c", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/typestate_analysis_fileio", checksumkind: CSK_MD5, checksum: "4f44a667050d627f36cdfc114ed02918")
...
!9 = !DIFile(filename: "test/llvm_test_code/typestate_analysis_fileio/typestate_03.c", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "4f44a667050d627f36cdfc114ed02918")
...
!86 = !DILocation(line: 7, column: 7, scope: !81)
!87 = !DILocation(line: 7, column: 5, scope: !81)
!88 = !DILocation(line: 9, column: 7, scope: !81)
!89 = !DILocation(line: 9, column: 3, scope: !81)
!90 = !DILocation(line: 11, column: 3, scope: !81)
