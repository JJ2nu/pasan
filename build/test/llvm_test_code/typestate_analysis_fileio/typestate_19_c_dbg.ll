; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_19.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_19.c"
...
entry:
  ...
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8, !dbg !78
...
while.cond:                                       ; preds = %while.body, %entry
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !89
  %call = call i32 @getc(%struct._IO_FILE* noundef %0), !dbg !90
  store i32 %call, i32* %i, align 4, !dbg !91
  %cmp = icmp ne i32 %call, -1, !dbg !92
  br i1 %cmp, label %while.body, label %while.end, !dbg !88

while.body:                                       ; preds = %while.cond
  %1 = load i32, i32* %i, align 4, !dbg !93
  %2 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !94
  %call1 = call i32 @putc(i32 noundef %1, %struct._IO_FILE* noundef %2), !dbg !95
  br label %while.cond, !dbg !88, !llvm.loop !96

while.end:                                        ; preds = %while.cond
  %call2 = call noalias %struct._IO_FILE* @fopen(i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)), !dbg !99
  store %struct._IO_FILE* %call2, %struct._IO_FILE** %f, align 8, !dbg !100
  %3 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !101
  call void @foo(%struct._IO_FILE* noundef %3), !dbg !102
  ret i32 0, !dbg !103
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_19.c", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/typestate_analysis_fileio", checksumkind: CSK_MD5, checksum: "6c754661047412c951f80cfaf3caf147")
...
!9 = !DIFile(filename: "test/llvm_test_code/typestate_analysis_fileio/typestate_19.c", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "6c754661047412c951f80cfaf3caf147")
...
!86 = !DILocalVariable(name: "i", scope: !81, file: !9, line: 9, type: !19)
!87 = !DILocation(line: 9, column: 7, scope: !81)
!88 = !DILocation(line: 11, column: 3, scope: !81)
!89 = !DILocation(line: 11, column: 20, scope: !81)
!90 = !DILocation(line: 11, column: 15, scope: !81)
!91 = !DILocation(line: 11, column: 13, scope: !81)
!92 = !DILocation(line: 11, column: 24, scope: !81)
!93 = !DILocation(line: 12, column: 10, scope: !81)
!94 = !DILocation(line: 12, column: 13, scope: !81)
!95 = !DILocation(line: 12, column: 5, scope: !81)
!96 = distinct !{!96, !88, !97, !98}
!97 = !DILocation(line: 12, column: 14, scope: !81)
!98 = !{!"llvm.loop.mustprogress"}
!99 = !DILocation(line: 14, column: 7, scope: !81)
!100 = !DILocation(line: 14, column: 5, scope: !81)
!101 = !DILocation(line: 16, column: 7, scope: !81)
!102 = !DILocation(line: 16, column: 3, scope: !81)
!103 = !DILocation(line: 18, column: 3, scope: !81)
