; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_07.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_07.c"
...
entry:
  ...
  %call = call i32 @fclose(%struct._IO_FILE* noundef %0), !dbg !87
  %call1 = call noalias %struct._IO_FILE* @fopen(i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)), !dbg !88
  store %struct._IO_FILE* %call1, %struct._IO_FILE** %f, align 8, !dbg !89
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !90
  call void @foo(%struct._IO_FILE* noundef %1), !dbg !91
  ret i32 0, !dbg !92
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_07.c", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/typestate_analysis_fileio", checksumkind: CSK_MD5, checksum: "1e594eab5f7e688ce96cb1e1c976732d")
...
!8 = distinct !DISubprogram(name: "foo", scope: !9, file: !9, line: 3, type: !10, scopeLine: 3, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !75)
!9 = !DIFile(filename: "test/llvm_test_code/typestate_analysis_fileio/typestate_07.c", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "1e594eab5f7e688ce96cb1e1c976732d")
...
!75 = !{}
!76 = !DILocalVariable(name: "f", arg: 1, scope: !8, file: !9, line: 3, type: !12)
!77 = !DILocation(line: 3, column: 16, scope: !8)
!78 = !DILocation(line: 3, column: 28, scope: !8)
!79 = !DILocation(line: 3, column: 21, scope: !8)
!80 = !DILocation(line: 3, column: 32, scope: !8)
!81 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 5, type: !82, scopeLine: 5, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !75)
!82 = !DISubroutineType(types: !83)
!83 = !{!19}
!84 = !DILocalVariable(name: "f", scope: !81, file: !9, line: 6, type: !12)
!85 = !DILocation(line: 6, column: 9, scope: !81)
!86 = !DILocation(line: 7, column: 10, scope: !81)
!87 = !DILocation(line: 7, column: 3, scope: !81)
!88 = !DILocation(line: 8, column: 7, scope: !81)
!89 = !DILocation(line: 8, column: 5, scope: !81)
!90 = !DILocation(line: 10, column: 7, scope: !81)
!91 = !DILocation(line: 10, column: 3, scope: !81)
!92 = !DILocation(line: 12, column: 3, scope: !81)
