; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_15.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_15.c"
...
entry:
  ...
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !80
  %call1 = call i32 @fclose(%struct._IO_FILE* noundef %0), !dbg !81
  %call2 = call noalias %struct._IO_FILE* @fopen(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)), !dbg !82
  store %struct._IO_FILE* %call2, %struct._IO_FILE** %f, align 8, !dbg !83
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** %f, align 8, !dbg !84
  %call3 = call i32 @fclose(%struct._IO_FILE* noundef %1), !dbg !85
  ret i32 0, !dbg !86
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/typestate_analysis_fileio/typestate_15.c", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/typestate_analysis_fileio", checksumkind: CSK_MD5, checksum: "e09db900f398ff67b6fc89865303c7ba")
...
!9 = !DIFile(filename: "test/llvm_test_code/typestate_analysis_fileio/typestate_15.c", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "e09db900f398ff67b6fc89865303c7ba")
...
!80 = !DILocation(line: 6, column: 10, scope: !8)
!81 = !DILocation(line: 6, column: 3, scope: !8)
!82 = !DILocation(line: 7, column: 7, scope: !8)
!83 = !DILocation(line: 7, column: 5, scope: !8)
!84 = !DILocation(line: 8, column: 10, scope: !8)
!85 = !DILocation(line: 8, column: 3, scope: !8)
!86 = !DILocation(line: 10, column: 3, scope: !8)
