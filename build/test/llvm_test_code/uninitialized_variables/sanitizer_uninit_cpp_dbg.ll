; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/sanitizer_uninit.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/sanitizer_uninit.cpp"
...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %j, metadata !212, metadata !DIExpression()), !dbg !213
  %0 = load i32, i32* %j, align 4, !dbg !214
  store i32 %0, i32* %i, align 4, !dbg !215
  store i32 42, i32* %i, align 4, !dbg !216
  %1 = load i32, i32* %i, align 4, !dbg !217
  %cmp = icmp eq i32 %1, 42, !dbg !218
  br i1 %cmp, label %cond.true, label %cond.false, !dbg !217

cond.true:                                        ; preds = %entry
  br label %cond.end, !dbg !217

cond.false:                                       ; preds = %entry
  %2 = load i32, i32* %j, align 4, !dbg !219
  br label %cond.end, !dbg !217

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ 0, %cond.true ], [ %2, %cond.false ], !dbg !217
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/sanitizer_uninit.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/uninitialized_variables", checksumkind: CSK_MD5, checksum: "b9e290a873e5c42b669e27c17a49bc42")
...
!170 = !DIFile(filename: "test/llvm_test_code/uninitialized_variables/sanitizer_uninit.cpp", directory: "/home/jinu/Desktop/phasar")
...
!207 = distinct !DISubprogram(name: "main", scope: !208, file: !208, line: 2, type: !108, scopeLine: 2, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !209)
!208 = !DIFile(filename: "test/llvm_test_code/uninitialized_variables/sanitizer_uninit.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "b9e290a873e5c42b669e27c17a49bc42")
!209 = !{}
!210 = !DILocalVariable(name: "i", scope: !207, file: !208, line: 3, type: !25)
!211 = !DILocation(line: 3, column: 7, scope: !207)
!212 = !DILocalVariable(name: "j", scope: !207, file: !208, line: 4, type: !25)
!213 = !DILocation(line: 4, column: 7, scope: !207)
!214 = !DILocation(line: 5, column: 7, scope: !207)
!215 = !DILocation(line: 5, column: 5, scope: !207)
!216 = !DILocation(line: 6, column: 5, scope: !207)
!217 = !DILocation(line: 7, column: 10, scope: !207)
!218 = !DILocation(line: 7, column: 12, scope: !207)
!219 = !DILocation(line: 7, column: 24, scope: !207)
!220 = !DILocation(line: 7, column: 3, scope: !207)
