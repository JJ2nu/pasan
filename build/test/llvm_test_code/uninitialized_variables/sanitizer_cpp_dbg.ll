; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/sanitizer.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/sanitizer.cpp"
...
entry:
  ...
  store i32 42, i32* %i, align 4, !dbg !20
  %1 = load i32, i32* %i, align 4, !dbg !21
  %cmp = icmp eq i32 %1, 42, !dbg !22
  %2 = zext i1 %cmp to i64, !dbg !21
  %cond = select i1 %cmp, i32 0, i32 1, !dbg !21
  ret i32 %cond, !dbg !23
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/sanitizer.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/uninitialized_variables", checksumkind: CSK_MD5, checksum: "f0b6284eb6d69bab58066308ba22cfad")
...
!9 = !DIFile(filename: "test/llvm_test_code/uninitialized_variables/sanitizer.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "f0b6284eb6d69bab58066308ba22cfad")
...
!22 = !DILocation(line: 6, column: 12, scope: !8)
