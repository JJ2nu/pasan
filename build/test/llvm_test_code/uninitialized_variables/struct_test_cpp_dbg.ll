; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/struct_test.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/struct_test.cpp"
...
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.MyStruct* %s, metadata !210, metadata !DIExpression()), !dbg !215
  %x = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %s, i32 0, i32 0, !dbg !216
  %0 = load i32, i32* %x, align 4, !dbg !216
  %y = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %s, i32 0, i32 1, !dbg !217
  %1 = load i32, i32* %y, align 4, !dbg !217
  %call = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 noundef %0, i32 noundef %1), !dbg !218
  ret i32 0, !dbg !219
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/struct_test.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/uninitialized_variables", checksumkind: CSK_MD5, checksum: "9a5ec29a18b1d7b323e1111c1287e287")
...
!170 = !DIFile(filename: "test/llvm_test_code/uninitialized_variables/struct_test.cpp", directory: "/home/jinu/Desktop/phasar")
...
!207 = distinct !DISubprogram(name: "main", scope: !208, file: !208, line: 6, type: !108, scopeLine: 6, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !209)
!208 = !DIFile(filename: "test/llvm_test_code/uninitialized_variables/struct_test.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "9a5ec29a18b1d7b323e1111c1287e287")
!209 = !{}
!210 = !DILocalVariable(name: "s", scope: !207, file: !208, line: 7, type: !211)
!211 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "MyStruct", file: !208, line: 3, size: 64, flags: DIFlagTypePassByValue, elements: !212, identifier: "_ZTS8MyStruct")
!212 = !{!213, !214}
!213 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !211, file: !208, line: 4, baseType: !25, size: 32)
!214 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !211, file: !208, line: 4, baseType: !25, size: 32, offset: 32)
!215 = !DILocation(line: 7, column: 12, scope: !207)
!216 = !DILocation(line: 8, column: 26, scope: !207)
!217 = !DILocation(line: 8, column: 31, scope: !207)
!218 = !DILocation(line: 8, column: 3, scope: !207)
!219 = !DILocation(line: 9, column: 3, scope: !207)
