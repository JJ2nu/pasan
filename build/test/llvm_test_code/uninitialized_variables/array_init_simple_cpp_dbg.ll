; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/array_init_simple.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/array_init_simple.cpp"
...
entry:
  ...
  call void @llvm.dbg.declare(metadata [5 x i32]* %arr, metadata !210, metadata !DIExpression()), !dbg !214
  %arrayidx = getelementptr inbounds [5 x i32], [5 x i32]* %arr, i64 0, i64 0, !dbg !215
  store i32 1, i32* %arrayidx, align 16, !dbg !216
  %arrayidx1 = getelementptr inbounds [5 x i32], [5 x i32]* %arr, i64 0, i64 1, !dbg !217
  store i32 2, i32* %arrayidx1, align 4, !dbg !218
  %arrayidx2 = getelementptr inbounds [5 x i32], [5 x i32]* %arr, i64 0, i64 2, !dbg !219
  store i32 3, i32* %arrayidx2, align 8, !dbg !220
  %arrayidx3 = getelementptr inbounds [5 x i32], [5 x i32]* %arr, i64 0, i64 3, !dbg !221
  store i32 4, i32* %arrayidx3, align 4, !dbg !222
  %arrayidx4 = getelementptr inbounds [5 x i32], [5 x i32]* %arr, i64 0, i64 4, !dbg !223
  store i32 5, i32* %arrayidx4, align 16, !dbg !224
  %arrayidx5 = getelementptr inbounds [5 x i32], [5 x i32]* %arr, i64 0, i64 3, !dbg !225
  %0 = load i32, i32* %arrayidx5, align 4, !dbg !225
  %call = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 noundef %0), !dbg !226
  ret i32 0, !dbg !227
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/array_init_simple.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/uninitialized_variables", checksumkind: CSK_MD5, checksum: "3c497348fe5aa0244ccacb554a33eac0")
...
!170 = !DIFile(filename: "test/llvm_test_code/uninitialized_variables/array_init_simple.cpp", directory: "/home/jinu/Desktop/phasar")
...
!207 = distinct !DISubprogram(name: "main", scope: !208, file: !208, line: 3, type: !108, scopeLine: 3, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !209)
!208 = !DIFile(filename: "test/llvm_test_code/uninitialized_variables/array_init_simple.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "3c497348fe5aa0244ccacb554a33eac0")
!209 = !{}
!210 = !DILocalVariable(name: "arr", scope: !207, file: !208, line: 4, type: !211)
!211 = !DICompositeType(tag: DW_TAG_array_type, baseType: !25, size: 160, elements: !212)
!212 = !{!213}
!213 = !DISubrange(count: 5)
!214 = !DILocation(line: 4, column: 7, scope: !207)
!215 = !DILocation(line: 5, column: 3, scope: !207)
!216 = !DILocation(line: 5, column: 10, scope: !207)
!217 = !DILocation(line: 6, column: 3, scope: !207)
!218 = !DILocation(line: 6, column: 10, scope: !207)
!219 = !DILocation(line: 7, column: 3, scope: !207)
!220 = !DILocation(line: 7, column: 10, scope: !207)
!221 = !DILocation(line: 8, column: 3, scope: !207)
!222 = !DILocation(line: 8, column: 10, scope: !207)
!223 = !DILocation(line: 9, column: 3, scope: !207)
!224 = !DILocation(line: 9, column: 10, scope: !207)
!225 = !DILocation(line: 10, column: 18, scope: !207)
!226 = !DILocation(line: 10, column: 3, scope: !207)
!227 = !DILocation(line: 11, column: 3, scope: !207)
