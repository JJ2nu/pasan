; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/array_init.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/array_init.cpp"
...
entry:
  ...
  %0 = bitcast [5 x i32]* %arr to i8*, !dbg !214
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %0, i8* align 16 bitcast ([5 x i32]* @__const.main.arr to i8*), i64 20, i1 false), !dbg !214
  %arrayidx = getelementptr inbounds [5 x i32], [5 x i32]* %arr, i64 0, i64 3, !dbg !215
  %1 = load i32, i32* %arrayidx, align 4, !dbg !215
  %call = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 noundef %1), !dbg !216
  ret i32 0, !dbg !217
}
...
!1 = !DIFile(filename: "/home/jinu/Desktop/phasar/test/llvm_test_code/uninitialized_variables/array_init.cpp", directory: "/home/jinu/Desktop/phasar/build/test/llvm_test_code/uninitialized_variables", checksumkind: CSK_MD5, checksum: "7390dcb96488e15cfeca4517c9f5478a")
...
!170 = !DIFile(filename: "test/llvm_test_code/uninitialized_variables/array_init.cpp", directory: "/home/jinu/Desktop/phasar")
...
!208 = !DIFile(filename: "test/llvm_test_code/uninitialized_variables/array_init.cpp", directory: "/home/jinu/Desktop/phasar", checksumkind: CSK_MD5, checksum: "7390dcb96488e15cfeca4517c9f5478a")
!209 = !{}
...
!215 = !DILocation(line: 5, column: 18, scope: !207)
!216 = !DILocation(line: 5, column: 3, scope: !207)
