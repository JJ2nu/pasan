; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/summary_generation/summary_class_3.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/summary_generation/summary_class_3.cpp"
...
entry:
  ...
  call void @_ZN5Point4setXEi(%class.Point* noundef nonnull align 4 dereferenceable(8) %p, i32 noundef 13)
  call void @_ZN5Point4setYEi(%class.Point* noundef nonnull align 4 dereferenceable(8) %p, i32 noundef 42)
...
define linkonce_odr dso_local void @_ZN5Point4setXEi(%class.Point* noundef nonnull align 4 dereferenceable(8) %this, i32 noundef %a) #2 comdat align 2 {
entry:
  %this.addr = alloca %class.Point*, align 8
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN5Point4setYEi(%class.Point* noundef nonnull align 4 dereferenceable(8) %this, i32 noundef %b) #2 comdat align 2 {
entry:
  %this.addr = alloca %class.Point*, align 8
...
; Function Attrs: mustprogress noinline optnone uwtable
define linkonce_odr dso_local noundef i32 @_ZN5Point4getXEv(%class.Point* noundef nonnull align 4 dereferenceable(8) %this) #0 comdat align 2 {
entry:
  %this.addr = alloca %class.Point*, align 8
  store %class.Point* %this, %class.Point** %this.addr, align 8
  %this1 = load %class.Point*, %class.Point** %this.addr, align 8
  ...
  %call = call noundef i32 @_ZN5Point8identityEi(%class.Point* noundef nonnull align 4 dereferenceable(8) %this1, i32 noundef %0)
  ret i32 %call
}
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define linkonce_odr dso_local noundef i32 @_ZN5Point8identityEi(%class.Point* noundef nonnull align 4 dereferenceable(8) %this, i32 noundef %i) #2 comdat align 2 {
entry:
  %this.addr = alloca %class.Point*, align 8
