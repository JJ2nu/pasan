; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/taint_analysis/taint_15.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/taint_analysis/taint_15.cpp"
...
entry:
  ...
  %xor1 = xor i32 %3, %2
  store i32 %xor1, i32* %argc.addr, align 4
  %4 = load i32, i32* %argc.addr, align 4
  %5 = load i32, i32* %x, align 4
  %xor2 = xor i32 %5, %4
  store i32 %xor2, i32* %x, align 4
  %6 = load i32, i32* %x, align 4
  %call = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i64 0, i64 0), i32 noundef %6)
  %7 = load i32, i32* %argc.addr, align 4
  %call3 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1, i64 0, i64 0), i32 noundef %7)
  ret i32 0
}
