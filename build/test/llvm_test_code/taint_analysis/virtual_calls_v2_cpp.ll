; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/taint_analysis/virtual_calls_v2.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/taint_analysis/virtual_calls_v2.cpp"
...
define dso_local noundef i32 @_Z3oofi(i32 noundef %i) #1 {
entry:
  %i.addr = alloca i32, align 4
  store i32 %i, i32* %i.addr, align 4
  %0 = load i32, i32* %i.addr, align 4
...
define dso_local noundef i32 @main(i32 noundef %argc, i8** noundef %argv) #3 {
entry:
...
if.else:                                          ; preds = %entry
  store i32 (i32)* @_Z3oofi, i32 (i32)** %bar, align 8
  br label %if.end
