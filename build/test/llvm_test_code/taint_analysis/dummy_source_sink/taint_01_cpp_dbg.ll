; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/taint_analysis/dummy_source_sink/taint_01.cpp'
...
entry:
  ...
  %call = call noundef i32 @_Z6sourcev(), !dbg !23
  store i32 %call, i32* %a, align 4, !dbg !22
  %0 = load i32, i32* %a, align 4, !dbg !24
  call void @_Z4sinki(i32 noundef %0), !dbg !25
  ret i32 0, !dbg !26
}
...
!23 = !DILocation(line: 5, column: 11, scope: !8)
!24 = !DILocation(line: 6, column: 8, scope: !8)
!25 = !DILocation(line: 6, column: 3, scope: !8)
