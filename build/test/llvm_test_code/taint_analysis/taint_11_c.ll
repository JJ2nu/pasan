; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/taint_analysis/taint_11.c'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/taint_analysis/taint_11.c"
...
define dso_local i32 @quk(i32 noundef %i) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @baz(i32 noundef %i) #0 {
entry:
  %i.addr = alloca i32, align 4
  store i32 %i, i32* %i.addr, align 4
  %0 = load i32, i32* %i.addr, align 4
  %call = call i32 @quk(i32 noundef %0)
  ret i32 %call
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @bar(i32 noundef %i) #0 {
entry:
  %i.addr = alloca i32, align 4
  store i32 %i, i32* %i.addr, align 4
  %0 = load i32, i32* %i.addr, align 4
  %call = call i32 @baz(i32 noundef %0)
  ret i32 %call
}
