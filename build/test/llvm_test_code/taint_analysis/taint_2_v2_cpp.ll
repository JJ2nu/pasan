; ModuleID = '/home/jinu/Desktop/phasar/test/llvm_test_code/taint_analysis/taint_2_v2.cpp'
source_filename = "/home/jinu/Desktop/phasar/test/llvm_test_code/taint_analysis/taint_2_v2.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_taint_2_v2.cpp, i8* null }]
...
define dso_local void @_Z12someFunctioni(i32 noundef %i) #4 {
entry:
...
define dso_local noundef i32 @main(i32 noundef %argc, i8** noundef %argv) #5 {
entry:
  ...
  call void @_Z12someFunctioni(i32 noundef %0)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_taint_2_v2.cpp() #0 section ".text.startup" {
entry:
